...
**Psychic Superiority** ◈ (enchantment, mental, occult) **Trigger** A creature targets the vetalarana manipulator with a mental effect or spell; The manipulator psychically lashes out at the triggering creature, dealing 3d8 mental damage (DC 24 basic Will save).
...
**Drain Thoughts** ◆ (divination, mental, occult) When Draining Thoughts, the vetalarana manipulator regains 14 HP.

**Paralyzing Claws** DC 27
