...
**Tumultuous Flash** ◇ (divination, occult, fortune) **Trigger** The gholdako is about to roll a d20; **Frequency** {"number":1,"unit":"day"}; Instead of rolling normally, the gholdako attempts a DC 11 flat check, getting a critical success on the triggering roll if the flat check succeeds or a critical failure if it fails.
...
**Melee** javelin +19 (range increment <30 feet>, thrown); **Damage** 3d6+10 piercing
