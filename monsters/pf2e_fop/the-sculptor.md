...
**Diplomacy** +8, Medicine +9, Stealth +9 Str +1, Dex +3, Con +3, Int +4, Wis +1
**Cha** +0 Items crafter's eyepiece, lesser bomber's eye elixir, orc knuckle dagger, studded leather armor.
...
**Quick Bomber** ◆ The Sculptor can use Interact to draw a bomb and then Strike with it.