...
**Grasping Bites** ◆◆ (attack) The cobbleswarm attempts an Athletics check and compares the result to the Fortitude DC of all creatures in its space. **Critical Success** The creature falls prone and takes 1d6 bludgeoning damage, and is restrained by the cobbleswarm until the end of the cobbleswarm's next turn.
