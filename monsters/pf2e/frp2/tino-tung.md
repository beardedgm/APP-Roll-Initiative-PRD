...
**Languages** nagaji, tengu, taldane, tien
...
**Fort** +23, **Ref** +26, **Will** +20; +1 status to all saves vs. disease

**HP** 240

**Retributive Strike** ◈ If Tino's Retributive Strike against the triggering creature doesn't critically miss, that creature meets the requirements for Tino to use Defiant Shove until the end of his next turn.
