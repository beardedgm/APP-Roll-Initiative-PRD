...
**Draining Glance** ◈ (aura, death, necromancy, occult, visual) **Trigger** A living creature within 30 feet that the bodak can perceive with its lifesense starts its turn; The target must attempt a DC 23 Fortitude save. If it fails, the bodak regains 5 Hit Points and the target becomes drained 1.
...
**Critical Failure** The creature is doomed 1 and drained 4. a rare version of the create undead
