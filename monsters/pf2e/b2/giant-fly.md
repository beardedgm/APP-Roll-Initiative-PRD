...
**Avoid the Swat** ◈ **Trigger** The giant fly is targeted with a melee or ranged attack by an attacker it can see; The giant fly gains a +2 circumstance bonus against the triggering attack. If the attack misses, the giant insect can Fly up to its fly Speed.
