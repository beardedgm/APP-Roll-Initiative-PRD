...
rare, ng, medium, siktempora, time
...
**Temporal Sense** A siktempora can always roll Dimension.
...
**HP** 210; regeneration 50 (deactivated by evil, mental, or orichalcum

**Immunities** poison, disease, emotion

**Deflect Aggression** ◈ (emotion, enchantment, mental, occult) **Trigger** The love siktempora is targeted by an attack; The siktempora glows with compassion, deflecting the attacker's aggression. The siktempora gains a +2 circumstance bonus to their AC and resistance 15 against the triggering attack, and the attacker must attempt a saving throw against the siktempora's heartsong (see below).

**Uncanny Pounce** ◇ **Trigger** The misery siktempora rolls Dimension of Time Lore for initiative; The misery siktempora Strides once and makes a claw Strike, in either order.
...
**Love's Impunity** The love siktempora's emotional bolt Strike doesn't trigger reactions that normally trigger based off making a ranged attack.

**Telepathic Ballad** ◆ (emotion, enchantment, mental, occult) The love siktempora casts inspire courage or inspire defense. It increases the area to a 200-foot emanation and increases the status bonuses the cantrip provides to +2.
