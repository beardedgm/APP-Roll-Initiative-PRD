...
**Pose a Riddle** ◆◆ (enchantment, incapacitation, linguistic, mental, occult) **Frequency** {"unit":"minute","interval":10,"number":1}; The sphinx recites a riddle and compels up to 10 creatures within 30 feet to answer (DC 37 Will save). The GM either runs the riddle out of character by timing the players' attempts, or picks an appropriate associated skill for the riddle, such as Religion for a riddle involving divine mysteries. The sphinx gains a +2 circumstance bonus to attack rolls and damage rolls against any creature that answers incorrectly even once. This bonus lasts for 1 day. **Critical Success** The creature is unaffected, but it can choose to try to help solve the riddle.
