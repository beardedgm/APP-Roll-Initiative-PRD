...
**Instant Suspension** ◈ **Trigger** The quintessivore reduces a creature within 15 feet of it to 0 Hit Points; The quintessivore uses Suspend Soul, targeting the creature.
...
**Prepared arcane Spells** (DC 29), attack +21
  ...
  **Cantrips (5th)** daze, detect magic, mage hand, ray of frost, read aura

  **1st** feather fall, fleet step, ray of enfeeblement
