...
**Skills** Acrobatics +21, Athletics +27, Deception +24, Intimidation +26, Nature +25, Stealth +21, Survival +23
...
**Fort** +25, **Ref** +22, **Will** +27

**HP** 290

**Immunities** poison, paralyzed, sleep

**Weaknesses** fire 10

**Frightful Presence** (aura, emotion, fear, mental) 90 feet, DC 32. Animals, fungi, and plants take a –2 circumstance penalty to the save.

**Fed by Water** ◈ (healing, necromancy, primal) **Trigger** The forest dragon is targeted with a water spell or effect; **Frequency** {"unit":"hour","number":1}; The forest dragon gains 35 temporary Hit Points.
...
**Melee** ◆ claw +29 (agile, magical, reach <10 feet>); **Damage** 3d8+13 slashing plus Grab

**Melee** ◆ tail +29 (magical, reach <25 feet>); **Damage** 3d8+13 bludgeoning plus Grab plus Grab

**Innate primal Spells** (DC 34)

  **Constant (1st)** pass without trace

  **Cantrips (4th)** know direction

  **4th** entangle, tree shape
