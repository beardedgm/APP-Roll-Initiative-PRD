...
rare, ce, medium, grioth, humanoid

---

**Perception** +10; echolocation 20 feet (precise), greater darkvision
...
**Melee** ◆ kukri +10 (agile, finesse, trip); **Damage** 1d6+2 slashing

**Melee** ◆ jaws +10 (agile, finesse); **Damage** 1d8+2 piercing plus grioth venom plus grioth venom
...
**Shock Mind** ◆◆ (enchantment, mental, occult) The grioth scout makes a Strike with a voidglass weapon. If the Strike hits, it deals an additional 2d6 mental damage, and the target must succeed at a DC 20 Will save (this has the incapacitation trait) or become confused for 1 round.

**Invoke Haunter of the Dark** ◆◆ (divine, enchantment, mental, visual) **Frequency** {"unit":"day","number":1}; The grioth cultist waves a hand in a complex pattern to invoke dark powers, dealing 3d8 mental damage. Each nongrioth creature within 20 feet must attempt a DC 20 Will save. **Critical Success** The creature is unaffected.
