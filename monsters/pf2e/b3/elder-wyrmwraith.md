...
**Draconic Frenzy** ◆◆ The wyrmwraith makes two claw Strikes and one jaws Strike in any order.

**Ectoplasmic Form** ◆ As wyrmwraith, except AC 52 and 125 temporary Hit Points.

**Phase Lurch** ◆ (divine, move) **Requirements** The wyrmwraith is in their ectoplasmic form; As the Stride action, but the wyrmwraith can pass through walls or material obstacles as though they were incorporeal. They must begin and end their movement outside of any physical obstacles, and passing through solid material is terrain.
