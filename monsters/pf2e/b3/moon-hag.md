...
**Moonlight's Kiss** A moon hag in an area illuminated by moonlight gains a +2 status bonus to AC and initiative rolls. In the light of a full moon, she is quickened, and can use the extra action only to Stride or Strike.
...
**Innate occult Spells** (DC 29)
  ...
  **5th** confusion, fear (at will), read omens, talking corpse (×3), tongues
