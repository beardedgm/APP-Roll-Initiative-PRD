...
rare, ne, medium, siktempora, time
...
**Skills** Athletics +35, Deception +32, Intimidation +32, Stealth +32, Dimension Of Time Lore +32
...
**Fort** +28, **Ref** +30, **Will** +33

**HP** 240; regeneration 50 (deactivated by good, mental, or orichalcum

**Immunities** poison, disease, emotion

**Impending Dread** (aura, emotion, fear, mental, occult) 150 feet. Creatures within the hatred siktempora's aura don't reduce the value of their frightened condition automatically at the end of their turns.
...
**Punish Flight** ◈ **Trigger** A creature attempts to Escape from the hatred siktempora; The siktempora makes a loathing garotte Strike against the triggering creature. This Strike doesn't have Improved Grab.
...
**Critical Failure** As failure, but double damage and the creature becomes restrained and can't speak for 1 round after it's no longer grabbed.
