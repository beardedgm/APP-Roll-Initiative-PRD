...
**Opportunistic Brawler** ◈ **Trigger** A creature hits the bruiser with a melee Strike; The bruiser attempts to Shove the creature. On a success or a critical success, the target is also knocked prone. The bruiser can't Stride after a target it successfully Shoves in this way.
