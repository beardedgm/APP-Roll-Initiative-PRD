...
unique, ne, medium, humanoid, lizardfolk
...
**Melee** hand crossbow +16 (magical, range increment <60 feet>, reload <1>); **Damage** 1d6+2 piercing plus 3d8 precision
...
**Deep Breath** Reth can hold his breath for 200 rounds (20 minutes).

**Running Reload** ◆ Reth Strides, Steps, or Sneaks, then Interacts to reload.

**Skirmishing Shot** ◆ (flourish) Reth Strides or Steps, then Strikes with his hand crossbow.
