...
**Resist Arcane Magic** ◈ **Trigger** Dwandek attempts a save against an arcane spell but hasn't rolled yet; **Frequency** {"number":1,"unit":"day"}; Dwandek automatically succeeds at his save against the triggering spell.
...
**Unflinching Spellcasting** If a reaction would disrupt Dwandek's spellcasting action, Dwandek attempts a DC 12 flat check. On a success, the action isn't disrupted.
