...
**Grab** ◆ When the zombie hits with its jaws Strike, it can use this action to automatically give the target the grabbed condition until the end of its next turn.
