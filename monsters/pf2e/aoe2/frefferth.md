...
**Impaler** Whenever Frefferth damages a creature with a critical hit using a ranged piercing weapon, the weapon remains impaled in the victim's body. The victim becomes clumsy|CRB|clumsy 1 as long as they are impaled; the impaling weapon can be removed by the affected creature or an adjacent ally as a 2-action activity that has the manipulate trait.

**Reap** ◆◆ As dullahan.

**Summon Steed** ◆◆ (conjuration, occult) As dullahan, except Frefferth summons a nightmare (Bestiary 244) instead. (This is already factored into Frefferth's level and the difficulty of this encounter.)
