...
unique, ne, large, construct, ooze
...
**Stretching Step** ◇ (move) **Frequency** {"number":1,"unit":"round"}; Tyrroicese forcefully extends a sticky pseudopod, plants it on a wall within 45 feet, and retracts the muscle. Tyrroicese springs over to a space adjacent to the wall, moving through the intervening squares as normal but ignoring any difficult or greater difficult terrain.
