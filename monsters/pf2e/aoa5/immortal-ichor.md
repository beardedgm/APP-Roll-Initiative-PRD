...
**Mental Erosion** A creature hit by the ichor's pseudopod is stupefied|CRB|stupefied 2 for 1 day unless it succeeds at a DC 35 Will save.

**Resanguinate** ◆◆◆ (divine, healing, necromancy) The immortal ichor draws blood from the pores of living creatures around it. Any living creature within 30 feet that has blood takes 4d6 damage (DC 33 basic Fortitude save). The immortal ichor regains HP equal to the total damage dealt. A creature that fails its save is also drained|CRB|drained 1 (or drained|CRB|drained 2 on a critical failure).
