...
**Fort** +7, **Ref** +9, **Will** +4; +1 status to all saves vs. magic, +2 status to all saves vs. mental
...
**Melee** ◆ main-gauche +9 (agile, disarm, finesse, parry, versatile <S>); **Damage** 1d4+2 piercing

**Ranged** ◆ hand crossbow +9 (range increment <60 feet>, reload <1>); **Damage** 1d6+1 piercing plus lethargy poison plus lethargy poison
