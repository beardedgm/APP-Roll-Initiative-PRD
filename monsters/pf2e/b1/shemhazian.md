...
**Perception** +30; darkvision, scent 60 feet (imprecise), true seeing
...
**Fort** +32, **Ref** +26, **Will** +27; +1 status to all saves vs. magic
...
**Tail Whip** ◈ **Trigger** A creature within reach of the shemhazian's tail leaves a square during a move action it's using.; The shemhazian attempts to Trip the triggering creature. On a success, the creature also takes damage as if the shemhazian had hit with a tail Strike, and if the creature was flying, it falls 30 feet.
...
**Innate divine Spells** (DC 37)
  ...
  **Constant (7th)** fly, true seeing

  **2nd** invisibility (at will)

  **4th** clairvoyance (×3), dimension door (at will)

  **5th** dimension door, prying eye (×3)
