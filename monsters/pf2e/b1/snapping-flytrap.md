...
**Perception** +7; {@ability tremorsense} 30 feet (imprecise)
...
**Hungry Flurry** ◆◆ The flytrap makes two leaf Strikes at a –2 penalty, each against a different target. These attacks count toward the flytrap's multiple attack penalty, but the multiple attack penalty doesn't increase until after it makes all its attacks.

**Swallow Whole** ◆ (attack) Medium, 1d8+1 bludgeoning plus 1d6 acid, Rupture 5.
