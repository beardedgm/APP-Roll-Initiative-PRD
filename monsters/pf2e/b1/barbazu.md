...
**Fort** +15, **Ref** +11, **Will** +11; +1 status to all saves vs. magic
...
**Reposition** ◇ **Trigger** The devil hits a creature with a glaive Strike.; The devil moves the creature 5 feet in any direction. The destination square must be within reach of the devil's glaive. This movement doesn't trigger reactions.

**Wriggling Beard** ◆ **Frequency** {"unit":"round","number":1}; The barbazu makes a beard Strike. This Strike ignores their multiple attack penalty and doesn't count toward that penalty.
