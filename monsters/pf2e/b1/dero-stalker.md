...
**Nimble Dodge** ◈ **Trigger** A creature targets the dero with an attack and the dero can see the attacker.; **Requirements** The dero stalker is not encumbered.; The dero dodges out of the way, gaining a +2 circumstance bonus to AC against the triggering attack.
