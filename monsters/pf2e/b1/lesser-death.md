...
**Fort** +30, **Ref** +33, **Will** +32; +1 status to all saves vs. magic
...
**Negative Healing** A lesser death can choose whether or not it takes positive damage.

**Lurking Death** ◈ (teleportation) As grim reaper, except the triggering creature must be within 60 feet.
