...
**Fort** +32, **Ref** +31, **Will** +37; +1 status to all saves vs. magic
...
**Reality Twist** ◈ **Trigger** The pleroma critically fails the saving throw.; The critical failure becomes a normal failure.
