...
**Fort** +30, **Ref** +28, **Will** +34; +1 status to all saves vs. magic
...
**Reshape Reality** (concentrate, divine, polymorph, transmutation) When the keketar casts hallucinatory terrain, it infuses the illusion with quasi-real substance. Creatures that do not disbelieve the illusion|CRB|2|disbelieving illusions|0 treat structures and terrain created through the spell as though they were real, ascending illusory stairs, becoming trapped by illusory quicksand, and so on.
