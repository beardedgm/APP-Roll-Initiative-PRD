...
**Verdant Burst** (healing) As leaf leshy, except only fungi are healed, they regain 2d8 Hit Points, and the area sprouts fungi.
...
**Melee** spore pod +10 (range increment <30 feet>); **Damage** 1d6+2 bludgeoning plus spores plus spores
...
**Spores** A creature that takes damage from a fungus leshy's spore pod Strike must attempt a saving throw with the same DC and effect as its Spore Cloud ability.
