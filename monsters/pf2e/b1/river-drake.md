...
**Tail Lash** ◈ **Trigger** A creature within reach of the river drake's tail uses an action to Strike or attempt a skill check.; The river drake attempts to Strike the triggering creature with its tail. If it hits, the creature takes a –2 circumstance penalty to the triggering roll.
...
**Speed Surge** ◆ **Frequency** {"number":3,"unit":"day"}; The river drake Strides or Flies twice.
