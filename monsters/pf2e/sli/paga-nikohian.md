...
**Halfling Luck** ◈ **Trigger** Paga fails or critically fails a skill check or a saving throw; **Frequency** {"unit":"day","number":1}; Paga rerolls the saving throw and must take the new result.
...
**Unbreakable Concentration** Paga's spells are disrupted by reactions only if she is critically hit.
