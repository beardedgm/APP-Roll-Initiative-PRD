...
**Putrid Evanescence** ◈ **Trigger** The howling spawn is damaged by another creature; **Frequency** {"unit":"hour","number":1}; The howling spawn bursts into a cloud of putrid smoke, ash, and nightmares, becoming invisible and teleporting up to 20 feet away to an unoccupied space it can see. It remains invisible until the end of its next turn or until it uses a hostile actions, whichever comes first.
...
**Profane Feast** ◆ **Requirements** The howling spawn has a creature grabbed; The howling spawn begins to consume the creature, dealing 2d12+5 piercing damage (DC 30 basic Fortitude save) and exposing the creature to its paralytic secretion.
