...
**Infused Items** A xulgath bomber carries the following infused items: 2 doses of concentrated xulgath bile, 2 moderate acid flasks, and 2 moderate alchemist's fires. These items last for 24 hours, or until the next time they make their daily preparations.
...
**Powerful Stench** (aura, olfactory) 30 feet. As xulgath skirmisher (page 27), but DC 24.
...
**Quick Bomber** ◆ The bomber Interacts to draw a bomb, then Strikes with it.
