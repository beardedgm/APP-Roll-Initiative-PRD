...
**Hidden Paragon** ◈ **Trigger** Olansa successfully uses Stealth to Hide and become hidden from all of her current foes, or she uses Stealth to Sneak and become undetected to all her current foes; **Frequency** {"unit":"hour","number":1}; Olansa becomes invisible for 1 minute, even if she uses a hostile action. Not even glitterdust, see invisibility, or similar effects can reveal her, though creatures can still use the Seek action to locate her.

**Opportune Backstab** ◈ **Trigger** A creature within Olansa's melee reach is hit by a melee attack from one of her allies; Olansa Strikes the triggering creature.
