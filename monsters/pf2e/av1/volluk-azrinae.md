...
unique, ce, medium, aberration, swarm
...
**Immunities** poison, disease, paralyzed

**Resistances** physical damage 7

**Weaknesses** area damage 7, splash damage 7

**Discorporate** As Worm That Walks Cultist|B2|worm that walks, but slow-moving leeches give the heroes 2 rounds, rather than 1 round, to dispatch the fleeing vermin before they escape.

**Hateful Memories** (enchantment, emotion, mental, occult, visual) If Volluk can see an accurate depiction of his former appearance as a living drow at the start of his turn, he must attempt a DC 28 Will save or become filled with self-loathing and become slowed|CRB|slowed 1 for 1 round.
