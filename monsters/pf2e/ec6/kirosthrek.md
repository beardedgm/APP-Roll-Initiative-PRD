...
**Fort** +31, **Ref** +33, **Will** +36

**HP** 375

**Resistances** mental 20

**Psychogenic Secretions** (aura, mental) 30 feet. As xulgath thoughtmaw (page 85), but DC 42.

**Divert Thoughts** ◈ (mental) **Trigger** Kirosthrek attempts a saving throw against a spell; Kirosthrek diverts some of the spell's energy, gaining a +2 circumstance bonus to the saving throw or +4 if the spell has the mental trait. If she critically succeeds at the saving throw, she can use the Cast a Spell action on her next turn to cast the triggering spell at the same level without expending any spell slots.
...
**Consume Knowledge** ◆◆ As xulgath thoughtmaw (page 85), but DC 42.
