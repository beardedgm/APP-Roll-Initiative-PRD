...
**Fort** +16, **Ref** +22, **Will** +20; +1 status to all saves vs. magic
...
**Corrupting Gaze** ◆◆ Belcorra stares at a creature she can see within 30 feet. The target takes 9d6 mental damage (DC 33 basic Will save). A creature that fails its save is also stupefied 1 for 1 minute.

**Haunted Lighthouse** ◆ **Frequency** {"number":1,"recurs":true,"interval":10,"unit":"minute"}; Belcorra extends her presence throughout the lowest three levels of Gauntlight until the end of her next turn. She can see with the benefits of all-around vision and can make ghostly hand attacks or use special abilities originating from any surface in this area.

**Quickened Casting** ◇ **Frequency** {"number":1,"unit":"day"}; If Belcorra's next action is to cast a sorcerer spell of 4th level or lower, she reduces the number of actions to cast it by 1 (minimum 1 action).
