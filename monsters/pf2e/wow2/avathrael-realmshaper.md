# Avathrael Realmshaper
*Creature 12*

unique, huge, dragon, plant, shadow
...
**Shadow Step** (arcane, healing, teleportation) **Frequency** {"number":2,"unit":"day"}; Avathrael teleports with the effects of a 4th-rank translocate|PC1 spell, but Avathrael must begin and end the teleportation effect in an area of dim light or darkness. If they use 2 actions to activate this ability, Avathrael also regains 8d10 Hit Points. Avathrael can't use Shadow Step again for 1d4 rounds.
...
**Snuff Light** ◇ **Frequency** {"number":1,"unit":"round"}; Avathrael exhales, automatically extinguishing all non-magical lights within 100 feet. Avathrael attempts to counteract each light source within 100 feet (+22 counteract).
