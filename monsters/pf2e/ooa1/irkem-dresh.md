...
**Defying Glare** ◈ **Trigger** A creature uses a mental effect against Dresh and fails or critically fails; Dresh Demoralizes that creature; when she does, Demoralize loses the auditory trait and gains the visual trait and she doesn't take a penalty if the creature doesn't understand her language.
...
**Silver Shower Shot** ◆ **Frequency** {"number":1,"unit":"round"}; Dresh throws 2d6 silver pieces into the air, potentially distracting her target. Dresh makes a Deception check to Feint against a creature within 30 feet that can see her and which she can see. If her flintlock pistol is loaded, Dresh then makes a ranged flintlock pistol Strike against that target.

**Sneak Attack** Dresh deals an additional 1d6 precision damage to flat-footed creatures.
