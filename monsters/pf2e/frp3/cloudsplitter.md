...
unique, lg, large, air, fire, phantom, spirit
...
**Fort** +28, **Ref** +32, **Will** +30

**HP** 335

**Immunities** fire, poison, precision, disease, paralyzed

**Peaceful Aura** (abjuration, aura, divine, emotion, mental) 60 feet. As kirin, but DC 39. Cloudsplitter allows anyone involved in the player character's bout with Jin-Hae to use hostile actions without a Will save.

**Deflecting Gale** ◈ As kirin.

**Susceptible to Death** As phantom knight (Pathfinder Bestiary 3 202).
...
**Trample** ◆◆◆ Medium or smaller, phantom hoof, DC 40
