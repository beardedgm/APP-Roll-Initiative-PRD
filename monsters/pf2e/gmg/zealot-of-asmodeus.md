...
**Swear Vengeance** ◈ **Trigger** A creature the zealot can see damages a follower of Asmodeus other than the zealot; The zealot gains the effect of a 1st-level true strike spell. If the zealot makes an attack roll against anyone other than the triggering creature, the true strike ends with no effect.
