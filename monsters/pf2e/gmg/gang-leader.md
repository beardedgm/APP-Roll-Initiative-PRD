...
**Nimble Dodge** ◈ **Trigger** The gang leader is targeted with an attack by an attacker they can see; The gang leader gains a +2 circumstance bonus to AC against the triggering attack.
...
**Melee** sling +18 (propulsive, range increment <50 feet>, reload <1>); **Damage** 1d6+8 bludgeoning
