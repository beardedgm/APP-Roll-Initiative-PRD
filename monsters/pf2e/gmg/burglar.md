...
**Nimble Dodge** ◈ **Trigger** The burglar is targeted with a melee or ranged attack by an attacker it can see; The burglar gains a +2 circumstance bonus to AC against the triggering attack.
...
**Sneak Attack** The burglar deals an extra 1d6 precision damage to flatfooted creatures.
