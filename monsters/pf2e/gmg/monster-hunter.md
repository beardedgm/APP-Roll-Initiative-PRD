...
**Skills** Athletics +15, Stealth +13, Survival +11, Monster Lore +13

**STR** +4, **DEX** +3, **CON** +3, **INT** +1, **WIS** +1, **CHA** +1

**Items** composite longbow (20 arrows), +1 greataxe, hide armor
...
**Melee** ◆ greataxe +15 (magical, sweep); **Damage** 1d12+8 slashing
