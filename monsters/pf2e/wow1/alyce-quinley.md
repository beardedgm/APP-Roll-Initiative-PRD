...
**Skills** Andoran Lore +16, Athletics +14, Forest Lore +12, Medicine +11, Nature +12, Stealth +15, Survival +15

**STR** +4, **DEX** +2, **CON** +3, **INT** +1, **WIS** +2, **CHA** +1

**Items** bedroll, crossbow (10 bolts), lesser potion of healing (2), maps, pup tent, , scale mail
...
**Ranged** ◆ crossbow +16 (range increment <120 feet>, reload <1>); **Damage** 1d8+8 piercing
