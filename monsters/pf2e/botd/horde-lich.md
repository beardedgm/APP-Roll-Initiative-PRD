...
**Fort** +21, **Ref** +27, **Will** +27; +1 status to all saves vs. positive
...
**Shatter Block** ◈ **Trigger** A creature scores a critical hit on the horde lich; **Requirements** The horde lich has at least one servitor attached (see Servitor Assembly); The critical hit is a normal hit instead. One of the horde lich's servitors detaches from them and is placed in an open, adjacent space, prone. The servitor takes the damage from the triggering attack.
...
**Servitor Lunge** ◆ **Requirements** The horde lich's last action was a critical hit with a melee Strike, and the horde lich has at least one servitor attached; One of the lich's attached servitors detaches adjacent to the target, and the target is grabbed by that servitor.
