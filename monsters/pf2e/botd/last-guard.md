...
**Ghostly Blades** **Frequency** {"number":1,"unit":"round"}; The last guards engage in a coordinated attack with their spectral curve blades against each enemy within 5 feet (DC 40 basic Reflex save). The damage depends on the number of actions. 1 1d8+2 slashing and 1d8 negative damage 2 2d8+14 slashing and 2d8 negative damage 3 3d8+14 slashing and 3d8 negative damage
