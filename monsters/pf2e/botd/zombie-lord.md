...
uncommon, ne, medium, undead, zombie
...
**Shamble Forth!** ◆ (concentrate, divine, necromancy) **Frequency** {"number":1,"unit":"round"}; Each zombie controlled by the zombie lord Strides 5 feet (or Burrows, Climbs, Flies, or Swims 5 feet if it has the corresponding movement type).
