...
**Fort** +13, **Ref** +17, **Will** +18; +1 status to all saves vs. magic

**HP** 125

**Immunities** disease

**Weaknesses** cold iron 6, good 6
...
**Compelled Performance** ◆◆ (divine, emotion, enchantment, mental) **Frequency** {"number":1,"unit":"day"}; Zridi grants the target a +2 status bonus to Performance checks for one week. The target must attempt a DC 26 Will save. **Critical Success** 
**Success** 
**Failure** 
**Critical Failure** 

**Tormenting Dreams** ◆◆ (divine, emotion, enchantment, mental) **Frequency** {"number":1,"unit":"day"}; Zridi torments a sleeping creature within 100 feet with visions of betrayals by loved ones and friends. The target must attempt a DC 26 Will save, with the effects of the nightmare|PC1 spell.
