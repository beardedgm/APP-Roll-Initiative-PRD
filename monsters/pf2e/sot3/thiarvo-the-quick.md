...
**Halfling Luck** ◈ (fortune) **Trigger** Thiarvo fails a skill check or a saving throw; **Frequency** {"number":1,"unit":"day"}; Thiarvo rerolls the triggering check and must use the new result.
