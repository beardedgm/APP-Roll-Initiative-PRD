...
uncommon, le, large, giant, humanoid
...
**Brutal Recovery** ◇ (divination, fortune, occult) **Trigger** The cyclops bully fails (but does not critically fail) an attack roll or an Intimidation check; **Frequency** {"number":1,"unit":"day"}; The cyclops bully forces its will on an array of possible futures. It gets a success on the roll instead of a failure.
