...
**Fort** +14, **Ref** +8, **Will** +11; +2 status to saves vs. magic

**HP** 62

**Knock It Away** ◈ **Trigger** Kragala is holding a drumstick and is targeted with a ranged weapon attack by an attacker she can see; Kragala gains a +2 circumstance bonus to AC against the triggering attack.
...
**Percussive Reverberation** Kragala deals an additional 1d6 damage with hammers, including drumsticks (already included in the Strikes' damage).
