...
**Fort** +22, **Ref** +18, **Will** +16; +2 status vs. fear effects
...
**Sweeping Tail** ◈ **Trigger** A creature within reach of the vorvorak's tail uses a move action or leaves a square during a move action it's using; The vorvorak attempts a tail Strike|PC1 against the triggering creature. If the attack is a critical hit, the vorvorak disrupts the action.
