...
**Items** +1 composite shortbow (60 arrows), {@item shortsword}

---

**AC** 25; all-around vision abilities
**Fort** +15, **Ref** +16, **Will** +14
**HP** 105
...
**Biting Snakes** ◈ **Trigger** A creature ends its turn adjacent to the medusa.; The medusa makes a snake fangs Strike against the creature.

---

Speed 25 feet

**Melee** shortsword +18 (agile, finesse, versatile <S>); **Damage** 1d6+8 piercing plus serpent venom plus serpent venom
**Melee** snake fangs +16 (agile, finesse); **Damage** 1d4+8 piercing plus serpent venom plus serpent venom
**Melee** composite shortbow +19 (deadly <1d10>, magical, propulsive, range increment <60 feet>, reload <0>); **Damage** 1d6+7 piercing plus serpent venom plus serpent venom
