...
**Fort** +37, **Ref** +32, **Will** +35; +1 status to all saves vs. magic
...
**Masterful Quickened Casting** ◇ (concentrate) **Frequency** {"unit":"round","number":1}; If the pit fiend's next action is to cast an 8th-level or lower innate spell, reduce the number of actions to cast it by 1 (minimum 1 action).

**Pit Fiend Venom** (poison)
