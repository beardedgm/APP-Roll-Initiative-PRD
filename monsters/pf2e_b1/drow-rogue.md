...
**AC** 19
**Fort** +6, **Ref** +10, **Will** +6; +1 status to all saves vs. magic, +2 status to all saves vs. mental
**HP** 26
**Immunities** sleep

**Nimble Dodge** ◈ **Trigger** The drow rogue is hit or critically hit by an attack made by a creature the drow rogue can see.; **Requirements** A drow rogue can't use this reaction while encumbered.; The drow rogue gains a +2 circumstance bonus to their Armor Class against the triggering attack.
