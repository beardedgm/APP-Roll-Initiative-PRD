...
**AC** 38
**Fort** +25, **Ref** +27, **Will** +29; +1 status to all saves vs. magic
**HP** 240; regeneration 20 (deactivated by acid or fire)
**Immunities** death effects, disease
**Resistances** negative 15, poison 15

**Wrappings Lash** ◈ **Trigger** A creature within reach of the morrigna's web wrappings uses an action to Strike or attempt a skill check.; The morrigna makes a web wrappings Strike against the triggering creature. If the strike is a critical hit, the triggering action is disrupted.
