...
**Fort** +20, **Ref** +15, **Will** +21; +2 status to all saves vs. magic
...
**Reactive Lash** ◈ **Trigger** A creature within reach of the roper's strand leaves a square during a move action it's using.; The roper makes a strand Strike against the triggering creature.
