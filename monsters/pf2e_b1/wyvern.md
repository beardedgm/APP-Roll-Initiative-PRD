...
**Savage** ◈ **Trigger** A creature grabbed by the wyvern critically fails a skill check to Escape.; The wyvern makes a stinger Strike against the triggering creature.
...
**Melee** claw +17; **Damage** 2d8+5 slashing plus Grab plus Grab
**Melee** stinger +15 (agile, reach <10 feet>); **Damage** 2d6+5 piercing plus wyvern venom plus wyvern venom
