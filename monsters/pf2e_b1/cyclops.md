...
**Flash of Insight** ◇ (divination, occult, fortune) **Trigger** The cyclops is about to roll a d20.; **Frequency** {"unit":"day","number":1}; The cyclops peers into an occluded spectrum of possible futures. It gets a success (but not a critical success) on the roll instead of rolling.
