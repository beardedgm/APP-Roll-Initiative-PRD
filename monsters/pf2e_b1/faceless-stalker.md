...
**Compression** When the faceless stalker successfully Squeezes, it moves through the tight space at full speed. Narrow confines are not terrain for a faceless stalker.

**Revert Form** ◇ **Requirements** The faceless stalker is in an assumed form.; The faceless stalker resumes its true form. Until the start of its next turn, it gains a +2 status bonus to attack rolls, damage rolls, saving throws, and skill checks.
