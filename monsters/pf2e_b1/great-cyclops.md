...
uncommon, ce, huge, giant, humanoid, mutant
...
**Catch Rock** ◈
**Ferocity** ◈
**Flash of Brutality** ◇ (divination, fortune, occult) **Trigger** The great cyclops succeeds at an attack roll.; **Frequency** {"special":"once per day, and recharges when the great cyclops uses Ferocity"}; The attack becomes a critical success.
...
**Melee** rock +23 (brutal, range increment <120 feet>); **Damage** 4d6+7 bludgeoning
