...
**Explosion** (fire) When the elemental inferno dies, it explodes, dealing 7d6 fire damage to each creature in a 10-foot emanation (DC 30 basic Reflex save).
...
**Melee** fire mote +24 (range increment <60 feet>); **Damage** 2d10+6 fire
