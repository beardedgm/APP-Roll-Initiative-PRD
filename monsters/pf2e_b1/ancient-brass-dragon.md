...
**Fort** +30, **Ref** +29, **Will** +30; +1 status to all saves vs. magic
...
**Desert Wind** ◆◆ (air, arcane, concentrate, evocation) **Frequency** {"unit":"day","number":3}; The dragon calls upon the desert wind. This has the same effect as gust of wind (DC 37 Fortitude) but in a 60-foot cone. A creature that fails its save is also blinded until the end of its next turn (or for 1 minute on a critical failure).
