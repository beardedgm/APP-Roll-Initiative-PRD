...
**Fort** +47, **Ref** +37, **Will** +39; +2 status to all saves vs. magic
...
**Inexorable** Tarrasque recovers from the slowed and stunned conditions at the end of its turn. It's also immune to penalties to its Speeds, and it ignores terrain and terrain.

**Reactive** Tarrasque gains 3 reactions each round. It can still use only one reaction per trigger.

**Attack of Opportunity** ◈ 

**Reflect** ◈ **Trigger** Tarrasque's carapace deflects an effect.; The effect is redirected back at its source.
...
**Melee** spine +45 (brutal, chaotic, evil, magical, range increment <120 feet>); **Damage** 3d10+20 piercing

**Destructive Frenzy** ◆◆◆ Tarrasque makes a jaws Strike, two claw Strikes, two horn Strikes, and one tail Strike in any order.

**Fast Swallow** ◈ **Trigger** Tarrasque Grabs a creature with its jaws; Tarrasque uses Swallow Whole.
