...
**AC** 40; or 36 vs. non-magical abilities
**Fort** +32, **Ref** +30, **Will** +28
**HP** 315
**Resistances** all 15

**Menace to Magic** ◈ (abjuration, primal) **Trigger** A creature within 60 feet Casts a Spell; The leydroth attempts an Intimidation check to counteract the triggering spell.
...
**Spell Feedback** (primal) Any time a leydroth counteracts a spell or item, the spell's caster or the creature holding the item takes 8d6 mental damage (DC 38 basic Will save).