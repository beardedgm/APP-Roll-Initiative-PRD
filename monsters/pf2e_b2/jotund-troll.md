...
**AC** 35; all-around vision abilities
**Fort** +31, **Ref** +23, **Will** +23
**HP** 360; regeneration 40 (deactivated by acid or fire)
**Weaknesses** fire 10
...
**Fast Swallow** ◈ **Trigger** The jotund troll Grabs a creature with their jaws; The troll uses Swallow Whole.
**Ravenous Jaws** ◆◆ The jotund troll makes a number of jaws Strikes up to their number of heads, each against a different target. These attacks count toward the troll's multiple attack penalty, but the penalty doesn't increase until after the jotund troll makes all of these attacks.
**Rend** ◆ (claw)
**Swallow Whole** ◆ (attack) Medium, 3d12+8 bludgeoning, Rupture 36.
**Throw Rock** ◆