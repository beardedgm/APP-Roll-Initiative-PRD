...
rare, ne, medium, aberration, negative
...
**Wing Flash** ◈ **Trigger** A creature attempts a melee attack against a sceaduinar or an; Acrobatics check to Tumble Through the sceaduinar's space; The sceaduinar flexes its wings to emit a brief pulse of negative energy that deals 4d6 negative damage to the triggering creature (DC 22 basic Reflex save).
