...
**Vanth's Curse** ◆◆ (curse, divine, enchantment, misfortune) **Frequency** {"unit":"day","number":3}; The vanth bestows a curse on a creature by touching it with its scythe. The creature must attempt a DC 25 Will save. **Critical Success** The target is unaffected and is temporarily immune to Vanth's Curse for 24 hours.
