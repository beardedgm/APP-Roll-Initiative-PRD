...
**Feign Death** ◈ **Trigger** The opossum is reduced below 70 HP; The khravgodon collapses. It is flat-footed and can use actions that require only its mind, but any other action ends the ruse. A successful DC 18 Perception check to Seek or Medicine check to Recall Knowledge is required to determine that the animal is not, in fact, dead.
**Revived Retaliation** ◈ **Trigger** The opossum is attacked or disturbed by a creature within reach while Feigning Death; The opossum Strikes the triggering creature.
...
**Grasping Tail** A khravgodon can drag a Large or smaller creature it has grabbed with its tail along with it when it Strides.