...
**AC** 30
**Fort** +19, **Ref** +21, **Will** +17
**HP** 175
**Weaknesses** fire 10

**Energizing Incompetence** ◈ **Trigger** A creature within 30 feet critically fails an attack against the oppali; The attack instead becomes a failure, and the oppali becomes quickened 1 for 1 round. It can use this extra action to Step, Stride, or Strike.
...
**Melee** staccato blast +23 (range <60 feet>, sonic); **Damage** 4d6 sonic
...
**Failure** 
**Critical Failure** 
**Trumpet Blast** ◆◆ (evocation, primal, sonic) The oppali emits a massive blast of discordant noise that deals 9d8 sonic damage to creatures within a 60-foot cone (DC 29 basic Fortitude save). Creatures who fail the save are also deafened for 1 round. The oppali can't use its Trumpet Blast again for 1d4 rounds or until it takes at least 20 points of sonic damage from a single source (whichever comes first).