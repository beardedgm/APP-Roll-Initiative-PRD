...
**Fort** +28, **Ref** +30, **Will** +28;  +1 status to all saves vs. mental
...
**Flurry of Blows** ◆ **Frequency** {"unit":"round","number":1}; The Rai Sho disciple makes two Strikes, each of which must be an unarmed Strike or temple bell Strike. If both hit the same creature, combine their damage for the purpose of resistances and weaknesses.
