...
**AC** 45
**Fort** +39, **Ref** +27, **Will** +33
**HP** 475; negative healing
**Immunities** cold, death effects, disease
**Weaknesses** fire 20

**Freezing Death** (aura, cold, evocation, primal) 20 feet. A creature that starts its turn in the aura takes 6d6 cold damage (DC 42 basic Fortitude). If the creature is grabbed or restrained by the sthira, it takes one degree of success worse than it rolled.
**Attack of Opportunity** ◈
**Frozen to the Touch** (cold) A creature that damages the sthira with an unarmed attack, tries to Grapple it, or otherwise touches it takes 6d6 cold damage (DC 42 basic Fortitude).
...
**Critical Failure** As failure, but the creature is also drained|CRB|drained 1.
