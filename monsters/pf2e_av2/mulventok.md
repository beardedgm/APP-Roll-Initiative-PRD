...
**Stay in the Fight** ◈ (healing, necromancy, occult) **Trigger** An allied creature within 30 feet reaches 0 HP; The mulventok imparts some of its own energy to keep the ally fighting. The target creature gains 1 Hit Point, and the mulventok takes 2d6 mental damage.
...
**Psychokinetic Honing** (occult, transmutation) A thrown weapon gains the effects of a returning rune when a mulventok throws it. Thrown weapons the mulventok uses deal an additional 1d6 mental damage, whether used in melee or thrown.
