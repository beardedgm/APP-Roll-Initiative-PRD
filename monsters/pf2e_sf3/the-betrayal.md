...
**Read the Cards** ◇ As fabled harrowkin|SF3.

---

**AC** 45
**Fort** +33, **Ref** +35, **Will** +31
**HP** 360
**Immunities** death effects, disease, doomed, drained, fatigued, healing, misfortune, necromancy, nonlethal attacks, paralyzed, poison, sickened, unconscious

**Defensive Suit** As fabled harrowkin|SF3.
**Twist Fate** ◈ (divination, fortune, occult) **Trigger** A creature critically hits the Betrayal; **Frequency** {"number":1,"unit":"minute"}; The Betrayal manipulates fortune in her favor. The triggering attack becomes a hit instead.
