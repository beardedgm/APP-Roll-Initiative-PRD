...
**Firebug** Lyzerius's alchemical items deal an additional 1 fire damage on a successful Strike.

**Natural-Born Burner** Any melee weapon Lyzerius uses deals an additional 1d6 fire damage.

**Quick Bomber** ◆ Lyzerius can Interact to draw a bomb and then make a Strike with it.
