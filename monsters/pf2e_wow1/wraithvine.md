...
**Light Vulnerability** Whenever a wraithvine begins its turn in an area of magical light, it is slowed 1 on that turn.
**Reactive Strike** ◈ Tentacle only.
...
**Wraithvine Venom** (poison) As wraithvine offshoot|WoW1; DC 25.