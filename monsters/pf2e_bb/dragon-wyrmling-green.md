...
**Twisting Tail** ◈ When a creature within 10 feet uses a move action or leaves a square during a move action it's using, the dragon can use their reaction to make a tail Strike at the creature with a –2 penalty. If it hits, the creature stops moving in the square it was in when the dragon used this reaction.
...
**Draconic Momentum** When the dragon gets a critical success on a Strike, they recharge their Breath Weapon.
