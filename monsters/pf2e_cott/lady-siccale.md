...
**HP** 360; coffin restoration, fast healing 15, void healing
...
**Create Servitor** (divine, downtime)

**Dominate** ◆◆ (divine, incapacitation, mental, visual) DC 38

**Drink Blood** ◆ (divine) When Drinking Blood, the Lady Siccale regains 36 HP.

**Poison Weapon** ◆ Lady Siccale applies poison to a dagger. If she has a free hand, she can Interact|PC1 to draw a poison as part of the action. If her next attack with that weapon hits and deals damage, it applies the effect of the poison. If she critically fails the attack roll, the poison is wasted.

**Turn to Mist** ◆ (air, concentrate, divine, polymorph)
