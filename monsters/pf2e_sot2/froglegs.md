...
unique, ne, small, grippli, humanoid
...
**Items** +1 daggers (4), Habu's Cudgel (page 76), leather armor, infiltrator thieves' tools
...
**Deny Advantage** Froglegs isn't flat-footed to creatures of 8th level or lower that are hidden, undetected, flanking|CRB|3|flanking, or using surprise attack.
...
**Roll and Snatch** ◇ **Trigger** Froglegs successfully Tumbles Through an enemy's space; Froglegs attempts to Disarm or Trip the enemy. She can use her tongue for this attempt and does not need to have a free hand.
**Twin Slash** ◆ (flourish) Froglegs makes two dagger Strikes.