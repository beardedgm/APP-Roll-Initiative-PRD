...
**Light Aura** (aura, divine, light) 30 feet. The bright walker sheds bright light. Any creature that starts its turn in the aura must attempt at a DC 24 Fortitude save. **Critical Success** The creature is temporarily immune for 24 hours.
...
**Light Flare** ◆◆ (divine, evocation, fire, light) **Requirements** The bright walker's Light Aura is suppressed; The bright walker reignites their Light Aura with a burst of brightness that deals 5d6 fire damage (DC 25 basic Reflex save) to creatures within a 20-foot burst. Creatures who are dazzled or with light blindness find this flare particularly painful; such a creature's save result is one degree of success worse than the result it rolled.
**Shadow Jump** ◆ (conjuration, divine, teleportation) **Requirements** The bright walker's Light Aura is suppressed; The bright walker teleports to a square it can see within 60 feet that is not in an area of bright light. The bright walker can't use Shadow Jump again for 1d4 rounds.