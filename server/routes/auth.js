 ...
 */
router.post('/api/auth/register', rateLimitByIP('register', 5), verifyTurnstile, validate(registerSchema), asyncHandler(async (req, res) => {
 ...
 * POST /api/auth/login
 */
router.post('/api/auth/login', rateLimitAuth, verifyTurnstile, validate(loginSchema), asyncHandler(async (req, res) => {
 ...
 */
router.post('/api/auth/verify-email', rateLimitByIP('verify-email', 5), asyncHandler(async (req, res) => {
 ...
 */
router.post('/api/auth/forgot-password', rateLimitByIP('forgot-password', 5), verifyTurnstile, validate(forgotPasswordSchema), asyncHandler(async (req, res) => {
 ...
 */
router.post('/api/auth/change-password', requireAuth, rateLimitByIP('change-password', 5), validate(changePasswordSchema), asyncHandler(async (req, res) => {
 ...
 */
router.patch('/api/auth/profile', requireAuth, validate(updateProfileSchema), asyncHandler(async (req, res) => {
...
router.delete('/api/auth/account', requireAuth, validate(deleteAccountSchema), asyncHandler(async (req, res) => {
  ...
  // Clean up user data (M-3: include UserData cleanup)
  await Promise.all([
    Encounter.deleteMany({ userId: user._id }),
    UserData.deleteOne({ userId: user._id }),
